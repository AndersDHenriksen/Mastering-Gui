...
class InvoiceView(qtw.QTextEdit):
    ...
    def build_invoice(self, data):
        document = qtg.QTextDocument()      # Start with a fresh document each time
        ...
        # cursor.insertImage('Mastering-GUI-Programming-with-Python/Chapter11/nc_logo.png')
        logo_image_fmt = qtg.QTextImageFormat()
        logo_image_fmt.setName('Mastering-GUI-Programming-with-Python/Chapter11/nc_logo.png')
